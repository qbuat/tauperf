...
def process_taus(
    ...
    for ilist, entry_list in enumerate(entry_lists):
        table_name = 'table_{}'.format(init_table_number + ilist)
        ...
        log.info('Filling table {0} for {1} taus with {2} entries '.format(
                table_name, suffix, len(entry_list)))
